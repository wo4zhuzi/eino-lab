...
CloudWeGo 官方的插件安装、调试地址配置、Test Run 和节点输入输出查看说明见：

- [Eino Dev 可视化调试插件功能指南](https://cloudwego.cn/zh/docs/eino/core_modules/devops/visual_debug_plugin_guide)

本文在官方指南基础上补充当前仓库的实际接入代码、验证命令、故障排查和生产级项目边界。
...
- [CloudWeGo：Eino Dev 可视化调试插件功能指南](https://cloudwego.cn/zh/docs/eino/core_modules/devops/visual_debug_plugin_guide)
