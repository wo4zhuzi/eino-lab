...
func (h *handlers) normalize(ctx context.Context, request Request) (reviewDraft, error) {
	...
	return reviewDraft{content: content, steps: []string{nodeNormalize}}, nil
}
...
func (h *handlers) approve(ctx context.Context, draft reviewDraft) (reviewDecision, error) {
	return h.decide(ctx, draft, true, RouteApproved, nodeApprove)
}

func (h *handlers) manual(ctx context.Context, draft reviewDraft) (reviewDecision, error) {
	return h.decide(ctx, draft, false, RouteManualReview, nodeManual)
}

func (h *handlers) decide(
	ctx context.Context,
	draft reviewDraft,
	approved bool,
	route string,
...
func (h *handlers) format(ctx context.Context, decision reviewDecision) (Result, error) {
	if err := ctx.Err(); err != nil {
