...
func (*handlers) normalize(ctx context.Context, request Request) (queryState, error) {
	...
	return queryState{originalQuestion: question, query: question}, nil
}
...
func (h *handlers) evidenceReady(ctx context.Context, state queryState) (retrievalOutcome, error) {
	return h.toOutcome(ctx, state, false)
}

func (h *handlers) noEvidence(ctx context.Context, state queryState) (retrievalOutcome, error) {
	return h.toOutcome(ctx, state, true)
}

func (*handlers) toOutcome(
	ctx context.Context,
	state queryState,
	noEvidence bool,
...
func (*handlers) format(ctx context.Context, draft answerDraft) (Result, error) {
	if err := ctx.Err(); err != nil {
